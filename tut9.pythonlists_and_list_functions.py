...
numbers.reverse()
print(numbers[0:4])#slicing the list that means selecting some particular numbers from the list
...
numbers.append('George')
numbers.insert(2,67)#inserts the number 67 after the first index
print(numbers)
